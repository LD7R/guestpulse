...
export default function CareersPage() {
  return (
    <main style={{ minHeight: "60vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "96px 48px", textAlign: "center", fontFamily: "Inter, -apple-system, sans-serif" }}>
      <p style={{ fontSize: 10, fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: "#6b7280", marginBottom: 16 }}>Careers</p>
      <h1 style={{ fontSize: 40, fontWeight: 700, color: "#ffffff", letterSpacing: "-1px", marginBottom: 16 }}>Work with us</h1>
      <p style={{ fontSize: 16, color: "#9ca3af", maxWidth: 480, lineHeight: 1.7, marginBottom: 24 }}>
        No open positions right now — but if you&apos;re passionate about helping independent hotels thrive,
